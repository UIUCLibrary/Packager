...
set(JENKINS_CI_DOCKER_IMAGE_NAME "packager" CACHE STRING "Name docker will use to generate an image to run Jenkinsfile runner")
find_path(JENKINS_CI_CASC_PATH
        NAMES casc
        PATHS ${PROJECT_SOURCE_DIR}/ci/jenkins/jenkinsfile-runner
...
add_custom_command(OUTPUT .jenkinsci
        ...
        DEPENDS
            ci/jenkins/jenkinsfile-runner/plugins.yaml
